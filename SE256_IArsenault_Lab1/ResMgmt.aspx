                            ...
                            <asp:GridView ID="gvResMgmt" runat="server" DataSourceID="sdsResMgmt" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="res_id" CssClass="table" PageSize="10">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="user_id" HeaderText="user_id" SortExpression="user_id" />
                                      <%--Hyperlink Column--%>
                                    <asp:HyperLinkField DataTextField="res_date" DataNavigateUrlFields="res_id" DataNavigateUrlFormatString="~/Reservation/{0}" HeaderText="Reservation Date" SortExpression="res_date" />     
